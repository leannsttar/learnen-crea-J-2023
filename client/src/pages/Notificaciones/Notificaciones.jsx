  ...
  return (
    <>
      ...
      {dataNotificaciones.map((data) => (
        <div
          className="flex items-center ml-10 mr-10 mt-14 mb-14 bg-gray-100 border-b border-zinc-400 p-4 rounded-xl"
          key={data.id}
        >
          ...
          <div className="ml-2">
            <img className="w-8 h-8 rounded-full" src={data.fotoPersona} alt="Avatar" />
          </div>
          <div className="ml-2">
