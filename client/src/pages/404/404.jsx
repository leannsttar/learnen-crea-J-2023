        ...
        <>
            <div class="flex h-[calc(100vh-80px)] items-center justify-center p-5 bg-white w-full">
                <div class="text-center space-y-8">
                    ...
                    <p class="text-slate-600 mt-5 lg:text-lg">La página que tu estas buscando no existe<br />o ha sido removida.</p>
                    <button type="button" class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 ">Default</button>
                </div>
            </div>
        </>
    )
