        ...
        <Fade bottom delay={500}>
          <div className="flex flex-col items-center 800:flex-row 800:gap-8 mb-4 800:mb-10 1280:w-[80%] w-[95%] ">
            ...
            <div className="flex gap-[30px] 800:gap-0 items-center 800:mt-10 800:w-full justify-between flex-col 800:flex-row translate-y-[-50px] 800:translate-y-[-40px]">
              <p className="text-[40px] leading-none text-center 800:w-min 880:w-auto">{usuario.nombre} {usuario.apellido}</p>
              <div className="flex gap-7">
                ...
                <ButtonHeader
                  ...
                  text="Message"
                />
                <button className="flex gap-3 px-5 py-2.5 shadow-square border border-black bg-[#fff] hover:bg-red-400 hover:transition-bg ease-in duration-200 flex-row-reverse" onClick={logout}>Cerrar sesión</button>
              </div>
            </div>
          </div>
        </Fade>
